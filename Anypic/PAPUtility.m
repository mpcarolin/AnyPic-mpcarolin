...
+ (void)likePhotoInBackground:(id)photo block:(void (^)(BOOL succeeded, NSError *error))completionBlock {
    ...
    [queryExistingLikes findObjectsInBackgroundWithBlock:^(NSArray *activities, NSError *error) {
        ...
        // set permissions to read only for public, read/write for user
        PFACL *likeACL = [PFACL ACLWithUser:[PFUser currentUser]];
        [likeACL setPublicReadAccess:YES];
        [likeACL setWriteAccess:YES forUser:[photo objectForKey:kPAPPhotoUserKey]];
        likeActivity.ACL = likeACL;

        // save the like activity in the background
        [likeActivity saveInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
            ...
            [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
                ...
                // send local notification to alert in memory view controller to reload relevant data
